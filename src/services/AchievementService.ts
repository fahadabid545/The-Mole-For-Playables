...
export const ACHIEVEMENTS: Achievement[] = [
  { id: 'first-win',    title: 'First Victory',     desc: 'Win your first level.',                            icon: TX.iconMedal },
  ...
  { id: 'daily-7',      title: 'Dedicated',        desc: 'Complete daily challenges 7 days in a row.',       icon: TX.iconCalendar },
];
